...
TIME_TOL_GYR = 1.0e-9
# Phase187 preregistration: sample GIZMO's canonical global energy diagnostic
# every 0.25 Gyr. init.c sets TimeLastStatistics=TimeBegin-TimeBetStatistics,
# so this cadence includes a time-zero baseline before the first drift metric.
ENERGY_STATISTICS_CADENCE_GYR = 0.25
...
def main():
    ...
    stat_code=ENERGY_STATISTICS_CADENCE_GYR/TIME_UNIT_GYR
...
TimeBetStatistics            {stat_code:.17g}
...
""")
    ...
    meta={
      ...
      "energy_statistics_cadence_Gyr":ENERGY_STATISTICS_CADENCE_GYR,
      "TimeBetStatistics_code":stat_code
    }
