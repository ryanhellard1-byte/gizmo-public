...
def main():
    ...
    times=[float(x) for x in r["analysis_times_Gyr"].split(",")]
    outlist=run/"output_times.txt"
    outlist.write_text("\n".join(f"{t/TIME_UNIT_GYR:.17g}" for t in times[1:])+"\n")
...
TimeBegin                    0.0
TimeMax                      {80.0/TIME_UNIT_GYR:.17g}
...
""")
    ...
    meta={
      ...
      "time_unit_Gyr":TIME_UNIT_GYR,"TimeMax_code":80.0/TIME_UNIT_GYR,
